...
class StockDataProcessor:
    ...
    def add_optimal_features(self, df):
        ...
        for ticker in df['Ticker'].unique():
            ...
            # Percentage Price Oscillator (momentum)
            ...
            ticker_df['BB_MAVG'] = bb.bollinger_mavg()
            ticker_df['BB_Width'] = (ticker_df['BB_High'] - ticker_df['BB_Low']) / ticker_df['BB_MAVG']
            ...
            ticker_df['MFI_14'] = mfi.money_flow_index() / 100  # normalize
    ...
    def run_pipeline(self, input_file="data/raw/multi_stock_merged.csv"):
        ...
        df = self.add_targets(df, horizon=5, threshold=0.02)
